"""
Django settings for zen_wisdom project.
...
SECRET_KEY = 'on)68-m==&nf(cl=mnxn_kb^h^hc@*xpsb1p$852j+n-o62-n*'
...
WSGI_APPLICATION = 'zen_wisdom.wsgi.application'
